    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Les utilisateurs seront effacés de Ahuva NMS après ce nombre de jour(s) sans connexion. 0 signifie `jamais`. Les utilisteurs seront créés à nouveau quand ils se reconnecteront.',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Cf documentation : Ahuva NMS support (varmaenosh@gmail.com)',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Ce domaine est utilisé pour la découverte automatique de réseau et d\'autres processus. Ahuva NMS essaie de le concatener aux noms incomplets.',
        ],
        'nfdump' => [
        ...
        'own_hostname' => [
            'description' => 'Nom d\'hôte Ahuva NMS',
            'help' => 'Doit être configuré avec le nom d\'hôte/IP du serveur Ahuva NMS.',
        ],
        'oxidized' => [
            'default_group' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Emplacement des fichiers rrd.  Défaut: fichiers rrd dans le répertoire de Ahuva NMS. La modification de cette valeur ne déplace pas les fichiers RRD.',
        ],
        'rrd_purge' => [
        ...
        'title_image' => [
            ...
            'help' => 'Remplace le logo Ahuva NMS sur la page d\'accueil/authentification',
        ],
        'traceroute' => [
