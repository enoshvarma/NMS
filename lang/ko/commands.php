...
return [
    ...
    'dev:check' => [
        'description' => 'Ahuva NMS 코드 검사. 옵션 없이 실행하면 모든 검사를 수행합니다.',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Ahuva NMS에 추가하거나 업데이트할 snmprec 파일의 이름(기본 이름만). 파일을 지정하지 않으면 장비가 추가되거나 업데이트되지 않습니다.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => '이전 키를 분실한 경우, 일부 Ahuva NMS 기능을 계속 사용하려면 암호화된 데이터를 모두 삭제해야 합니다.',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => '자세한 내용은 Ahuva NMS support (varmaenosh@gmail.com) 를 참조하세요.',
