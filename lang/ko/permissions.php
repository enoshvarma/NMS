...
return [
    'device' => [
        ...
        'create' => ['label' => '장비 추가', 'description' => 'Ahuva NMS에 새 장비 추가'],
        'update' => ['label' => '장비 편집', 'description' => '장비 설정 수정'],
        'delete' => ['label' => '장비 삭제', 'description' => 'Ahuva NMS에서 장비 제거'],
    ...
    'api' => [
        'title' => 'API 접근',
        'access' => ['label' => 'API 접근', 'description' => 'Ahuva NMS REST API 접근'],
    ],
    ...
    'poller' => [
        ...
        'delete' => ['label' => '폴러 삭제', 'description' => 'Ahuva NMS에서 폴러 제거'],
    ],
    ...
    'settings' => [
        'title' => '설정',
        'view' => ['label' => '설정 보기', 'description' => 'Ahuva NMS 전역 설정 보기'],
        'update' => ['label' => '설정 편집', 'description' => 'Ahuva NMS 전역 설정 수정'],
    ],
