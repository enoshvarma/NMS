    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => '이 기간(일) 동안 로그인하지 않은 사용자는 Ahuva NMS에서 삭제됩니다. 0은 삭제하지 않음을 의미하며, 해당 사용자가 다시 로그인하면 재생성됩니다.',
            ],
        ],
        ...
        'collectd_dir' => [
            ...
            'help' => 'Collectd가 RRD 파일을 저장하는 디렉터리입니다. Ahuva NMS에서 collectd 데이터를 표시하는 데 사용됩니다.',
        ],
        'collectd_sock' => [
            'description' => 'Collectd 소켓',
            'help' => 'Collectd가 수신 대기하는 소켓입니다. Ahuva NMS에서 collectd 데이터를 표시하는 데 사용됩니다.',
        ],
        'core_descr' => [
        ...
        'mydomain' => [
            'description' => '기본 도메인',
            'help' => '이 도메인은 네트워크 자동 탐색 및 기타 프로세스에 사용됩니다. Ahuva NMS는 비정규화된 호스트명에 이 도메인을 추가하려고 시도합니다.',
        ],
        ...
        'own_hostname' => [
            'description' => 'Ahuva NMS 호스트명',
            'help' => 'Ahuva NMS 서버가 추가된 호스트명/IP로 설정해야 합니다',
        ],
        'oxidized' => [
            'default_group' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'Oxidized로 나열된 OS를 백업하지 않습니다. OS는 Ahuva NMS OS 이름과 일치해야 합니다.',
            ],
            'ignore_types' => [
        ...
        'autodiscovery' => [
            ...
            'xdp' => [
                ...
                'help' => 'LLDP, CDP 등 프로토콜을 사용하여 네트워크 토폴로지와 이웃을 탐색하고 Ahuva NMS에 추가합니다',
            ],
            'xdp_exclude' => [
                'sysname_regexp' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => '분석 및 수정을 위해 Ahuva NMS에 일부 오류를 전송합니다',
            ],
            'usage' => [
                'description' => '사용량 보고서 전송',
                'help' => 'Ahuva NMS에 사용량 및 버전을 보고합니다. 익명 통계를 삭제하려면 정보 페이지를 방문하십시오.',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            'description' => 'RRD 위치',
            'help' => 'RRD 파일의 위치입니다. 기본값은 Ahuva NMS 디렉터리 내의 rrd입니다. 이 설정을 변경해도 RRD 파일이 이동되지 않습니다.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => '1.5.5 이상은 Ahuva NMS가 사용하는 모든 기능을 지원합니다. 설치된 버전보다 높게 설정하지 마십시오',
        ],
        'schedule_type' => [
            'alerting' => [
                'description' => '경보',
        ...
        'sensors' => [
            'guess_limits' => [
                ...
                'help' => '활성화되면 Ahuva NMS가 센서 유형과 값을 기반으로 센서 한도를 추정하려고 시도합니다. 항상 정확하지 않을 수 있습니다.',
            ],
        ],
        ...
        'service_watchdog_log' => [
            ...
            'help' => '기본값은 Ahuva NMS 로그 파일입니다. 모든 노드의 기본값을 설정합니다.',
        ],
        'service_health_file' => [
