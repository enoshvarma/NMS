...
return [
    ...
    'dev:check' => [
        'description' => 'Ahuva NMS-ის კოდის შემოწმებები. პარამეტრების გარეშე გაშვება ყველა შემოწმებას გაუშვებს',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'snmprec ფაილის სახელი (მხოლოდ სახელი) განახლებისთვის, ან Ahuva NMS-ში დასამატებლად. თუ ფაილი მითითებული არაა, მოწყობილობები არც დაემატება, არც განახლდება.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'თუ თქვენ არ გაქვთ ძველი გასაღები, ყველა დაშიფრული მონაცემები უნდა წაშალოთ, რომ Ahuva NMS-ის ზოგიერთი ფუნქცია გამოიყენოთ',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'მეტი ინფორმაციისთვის იხილეთ Ahuva NMS support (varmaenosh@gmail.com)"',
