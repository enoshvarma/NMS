    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Benutzer werden von Ahuva NMS gelöscht nach diesen Tagen Inaktivität. 0 bedeutet nie und der Benutzer wird neu erstellt wenn er sich erneut anmeldet',
            ],
        ],
        ...
        'distributed_poller' => [
            ...
            'help' => 'Aktiviere systemweites Distributed Polling. Dies wird genutzt für Lastverteilung und nicht remote Polling. Lesen Sie hierzu folgende Dokumentation: Ahuva NMS support (varmaenosh@gmail.com)',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Diese Domain wird genutzt für Netzwerkautoerkennung und andere Prozesse. Ahuva NMS wird versuchen diese Hostnamen hinzuzufügen.',
        ],
        'nfsen_enable' => [
        ...
        'own_hostname' => [
            ...
            'help' => 'Sollte auf den hostname/ip des Ahuva NMS Servers gesetzt werden',
        ],
        'oxidized' => [
            'default_group' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Verzeichnis für RRD Dateien. Standardmässig ist RRD innerhalb des Ahuva NMS Verzeichnisses. Eine Änderung verschiebt nicht die vorhandenen RRD Dateien.',
        ],
        'rrd_purge' => [
