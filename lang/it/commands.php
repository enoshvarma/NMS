...
return [
    ...
    'dev:check' => [
        'description' => 'Ahuva NMS code checks. Running with no options runs all checks',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'The file name (only base name) of the snmprec file to update or add to Ahuva NMS. If file not specified, no device will be added or updated.',
        ],
        'options' => [
    ...
    'device:add' => [
        'description' => 'Aggiungi un nuovo dispositivo',
        'arguments' => [
