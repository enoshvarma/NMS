...
return [
    ...
    'dev:check' => [
        'description' => 'Verificações de código do Ahuva NMS. Executar sem opções executa todas as verificações',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'O nome do arquivo (apenas o nome base) do arquivo snmprec para atualizar ou adicionar ao Ahuva NMS. Se o arquivo não for especificado, nenhum dispositivo será adicionado ou atualizado.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'Se você não tiver a chave antiga, deve excluir todos os dados criptografados para poder continuar a usar certos recursos do Ahuva NMS',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Para mais informações, veja Ahuva NMS support (varmaenosh@gmail.com)"',
