...
return [
    ...
    */
    ...
    'validations' => [
        'rrd' => [
            'CheckRrdVersion' => [
                'fail' => 'A versão do rrdtool :installed_version é muito antiga, o Ahuva NMS requer uma versão mínima de 1.5.5',
                'fail_config' => 'A rrdtool_version :config_version que você especificou é muito antiga, o Ahuva NMS requer uma versão mínima de 1.5.5',
