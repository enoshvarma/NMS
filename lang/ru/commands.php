...
return [
    ...
    'dev:check' => [
        'description' => 'Проверки кода Ahuva NMS. Запуск без опций выполняет все проверки',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Имя файла (только базовое имя) файла snmprec для обновления или добавления в Ahuva NMS. Если файл не указан, устройство не будет добавлено или обновлено.',
        ],
        'options' => [
    ...
    'device:poll' => [
        ...
        'errors' => [
            ...
            'none_actioned' => 'Не было опрошенных устройств.',
        ],
        'actioned' => 'Опросил :count устройств за :time',
    ],
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'Если у вас нет старого ключа, вы должны удалить все зашифрованные данные, чтобы продолжить использовать определенные функции Ahuva NMS',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Для получения дополнительной информации смотрите Ahuva NMS support (varmaenosh@gmail.com)"',
