...
return [
    ...
    'api' => [
        ...
        'access' => [
            'label' => 'API 存取',
            'description' => '存取 Ahuva NMS REST API',
        ],
    ],
    'application' => [
        'title' => '應用程式',
    ...
    'settings' => [
        ...
        'view' => [
            'label' => '檢視設定',
            'description' => '檢視 Ahuva NMS 全域設定',
        ],
        'update' => [
            'label' => '編輯設定',
            'description' => '修改 Ahuva NMS 全域設定',
        ],
    ],
    'syslog' => [
        'title' => 'Syslog',
