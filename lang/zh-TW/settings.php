    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => '設定使用者超過幾天沒有登入後，將會被 Ahuva NMS 自動刪除。設為 0 表示不會刪除，若使用者重新登入，將會重新建立帳戶。',
            ],
        ],
        ...
        'collectd_dir' => [
            ...
            'help' => 'Collectd 儲存其 RRD 檔案的目錄。用於在 Ahuva NMS 中顯示來自 collectd 的資料。',
        ],
        'collectd_sock' => [
            'description' => 'Collectd Socket',
            'help' => 'Collectd 監聽的 socket。用於在 Ahuva NMS 中顯示來自 collectd 的資料。',
        ],
        'core_descr' => [
        ...
        'distributed_poller' => [
            ...
            'help' => '於系統全域啟用分散式輪詢。此功能用於負載分擔，而非遠端輪詢。您必須閱讀文件以了解啟用步驟：Ahuva NMS support (varmaenosh@gmail.com)',
        ],
        ...
        'mydomain' => [
            'description' => '主要網域',
            'help' => '此網域用於網路自動探索及其他程序。Ahuva NMS 會嘗試將其附加到非完整網域名稱的主機名稱上。',
        ],
        ...
        'own_hostname' => [
            'description' => 'Ahuva NMS 主機名稱',
            'help' => '應設為 Ahuva NMS 伺服器被新增時所用的主機名稱／IP',
        ],
        'oxidized' => [
            'default_group' => [
                'description' => '設定預設群組',
            ...
            'ignore_os' => [
                ...
                'help' => '不要使用 Oxidized 備份所列的 OS。OS 必須與 Ahuva NMS 的 OS 名稱相符（皆為小寫且無空格）。僅允許既有的 OS。',
            ],
            'ignore_types' => [
        ...
        'autodiscovery' => [
            ...
            'xdp' => [
                ...
                'help' => '使用 LLDP、CDP 等協定探索網路拓撲與鄰居，並將其加入 Ahuva NMS',
            ],
            'xdp_exclude' => [
                'sysname_regexp' => [
        ...
        'reporting' => [
            'error' => [
                'description' => '發送錯誤報告',
                'help' => '將部分錯誤發送給 Ahuva NMS 以供分析與修正',
            ],
            'usage' => [
                'description' => '發送使用情況報告',
                'help' => '向 Ahuva NMS 回報使用情況與版本。若要刪除匿名統計，請造訪 about 頁面。您可於 Ahuva NMS support (varmaenosh@gmail.com) 檢視統計',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            'description' => 'RRD 位置',
            'help' => 'RRD 檔案的位置。預設為 Ahuva NMS 目錄內的 rrd。變更此設定不會移動現有的 RRD 檔案。',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => '1.5.5 以上的任何版本皆支援 Ahuva NMS 使用的所有功能，請勿設得高於您已安裝的版本',
        ],
        'schedule_type' => [
            'alerting' => [
                'description' => '警報',
        ...
        'sensors' => [
            'guess_limits' => [
                'description' => '推測感測器限制',
                'help' => '若啟用，Ahuva NMS 會嘗試根據感測器類型與數值推測感測器限制。這並非總是準確，可能導致不正確的限制。',
            ],
        ],
        ...
        'service_watchdog_log' => [
            'description' => '要監看的記錄檔',
            'help' => '預設為 Ahuva NMS 記錄檔。設定所有節點的預設值。',
        ],
        'service_health_file' => [
            'description' => '服務健康檔',
