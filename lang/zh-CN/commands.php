...
return [
    ...
    'dev:check' => [
        'description' => 'Ahuva NMS代码检查。不带选项运行时运行所有检查',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => '要更新或添加到Ahuva NMS的snmprec文件的基本文件名。如果没有指定文件，则不会添加或更新设备。',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => '如果您没有旧密钥，您必须删除所有加密数据才能继续使用Ahuva NMS的某些功能',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => '更多信息请参见 Ahuva NMS support (varmaenosh@gmail.com)"',
