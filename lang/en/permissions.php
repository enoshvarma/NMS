...
return [
    'device' => [
        ...
        'create' => ['label' => 'Add Devices', 'description' => 'Add new devices to Ahuva NMS'],
        'update' => ['label' => 'Edit Devices', 'description' => 'Modify device settings'],
        'delete' => ['label' => 'Delete Devices', 'description' => 'Remove devices from Ahuva NMS'],
    ...
    'api' => [
        'title' => 'API Access',
        'access' => ['label' => 'API Access', 'description' => 'Access the Ahuva NMS REST API'],
    ],
    ...
    'poller' => [
        ...
        'delete' => ['label' => 'Delete Pollers', 'description' => 'Remove pollers from Ahuva NMS'],
    ],
    ...
    'settings' => [
        'title' => 'Settings',
        'view' => ['label' => 'View Settings', 'description' => 'View global Ahuva NMS settings'],
        'update' => ['label' => 'Edit Settings', 'description' => 'Modify global Ahuva NMS settings'],
    ],
