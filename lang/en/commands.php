...
return [
    ...
    'dev:check' => [
        'description' => 'Ahuva NMS code checks. With no options, this command runs all checks',
        'arguments' => [
    ...
    'dev:collect-snmprec' => [
        ...
        'help' => "Collect the OIDs used by discovery and polling into an snmprec fixture.\n\n" .
            ...
            'Use -v to show captured OIDs, -vv for Ahuva NMS debug output, or -vvv for full verbose debug and SNMP output.',
        'arguments' => [
    ...
    'dev:generate-test-data' => [
        ...
        'help' => "Regenerate existing JSON fixtures, or explicitly recreate fixtures with --variant.\n\n" .
            ...
            'Use -v to show discovery and poller output, -vv for Ahuva NMS debug output, or -vvv for full verbose debug and SNMP output.',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'The file name (base name only) of the snmprec file to update or add to Ahuva NMS. If you do not specify a file, no device is added or updated.',
        ],
        'options' => [
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'If you do not have the old key, you must delete all encrypted data. Otherwise, you cannot use some Ahuva NMS features.',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'For more information see Ahuva NMS support (varmaenosh@gmail.com)"',
