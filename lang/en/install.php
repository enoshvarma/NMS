...
return [
    ...
    'database' => [
        ...
        'password' => 'Password',
        'port' => 'Port',
        'port_placeholder' => 'Leave empty for a Unix socket',
        'socket' => 'Unix-Socket',
        'socket_placeholder' => 'Use only for a custom socket path',
    ...
    'finish' => [
        ...
        'thanks' => 'Thank you for setting up Ahuva NMS.',
    ...
    'migrate' => [
        ...
        'error' => 'Error. Check the output for details.',
        'migrate' => 'Build Database',
        'retry' => 'Retry',
        'timeout' => 'The HTTP request timed out. Your database structure can be inconsistent.',
        'wait' => 'Wait...',
    ],
    'steps' => [
