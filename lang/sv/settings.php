    ...
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                ...
                'help' => 'Användare kommer att raderas från Ahuva NMS efter så många dagar att de inte loggat in. 0 betyder aldrig och användare kommer att återskapas om användaren loggar in igen.',
            ],
        ],
        ...
        'collectd_dir' => [
            ...
            'help' => 'Katalog där collectd lagrar sina RRD-filer.  Detta används för att visa data från insamlad i Ahuva NMS.',
        ],
        'collectd_sock' => [
            'description' => 'Collectd-socket',
            'help' => 'Socket collectd lyssnar på.  Detta används för att visa data från insamlad i Ahuva NMS.',
        ],
        'core_descr' => [
        ...
        'distributed_poller' => [
            ...
            'help' => 'Aktivera distribuerat avfrågningssystem. Detta är avsett för lastdelning, inte för fjärrpolling. Du måste läsa dokumentationen för steg för att aktivera: Ahuva NMS support (varmaenosh@gmail.com)',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'Den här domänen används för automatisk upptäckt av nätverk och andra processer. Ahuva NMS kommer att försöka lägga till det till okvalificerade värdnamn.',
        ],
        ...
        'own_hostname' => [
            'description' => 'Ahuva NMS värdnamn',
        ...
        'oxidized' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'Säkerhetskopiera inte det angivna operativsystemet med Oxidized.  OS måste matcha Ahuva NMS OS-namnet (dessa är alla gemener utan mellanslag).  Tillåter endast befintligt operativsystem.',
            ],
            'ignore_types' => [
        ...
        'autodiscovery' => [
            ...
            'xdp' => [
                ...
                'help' => 'Använd LLDP, CDP, etc protokoll för att upptäcka nätverkstopologi och grannar och lägga till dem i Ahuva NMS',
            ],
            'xdp_exclude' => [
                'sysname_regexp' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => 'Skickar några fel till Ahuva NMS för analys och korrigering',
            ],
            'usage' => [
                'description' => 'Skicka användningsrapporter',
                'help' => 'Rapporterar användning och versioner till Ahuva NMS. För att ta bort anonym statistik, besök sidan Om. Du kan se statistik på Ahuva NMS support (varmaenosh@gmail.com)',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Plats för rrd-filer.  Standard är rrd i Ahuva NMS-katalogen.  Att ändra denna inställning flyttar inte rrd-filerna.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'Allt över 1.5.5 stöder alla funktioner som Ahuva NMS använder, ställ inte in högre än din installerade version',
        ],
        'schedule_type' => [
            'alerting' => [
                'description' => 'Varning',
        ...
        'sensors' => [
            'guess_limits' => [
                ...
                'help' => 'Om det är aktiverat kommer Ahuva NMS att försöka gissa sensorgränserna baserat på sensortypen och -värdet. Detta är inte alltid korrekt och kan leda till felaktiga gränser.',
            ],
        ],
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'Standard är Ahuva NMS-loggfilen. Ställer in standardvärdet för alla noder.',
        ],
        'service_health_file' => [
