...
return [
    ...
    'validations' => [
        ...
        'rrd' => [
            'CheckRrdVersion' => [
                'fail' => 'rrdtool version :installed_version är för gammal, Ahuva NMS kräver en minsta version av 1.5.5',
                'fail_config' => 'Den rrdtool_version :config_version du har angett är för gammal, Ahuva NMS kräver en minsta version av 1.5.5',
