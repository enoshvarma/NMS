...
return [
    ...
    'dev:check' => [
        'description' => 'Ahuva NMS kodkontroller. Att köra utan alternativ kör alla kontroller',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Filnamnet (endast basnamn) för snmprec-filen som ska uppdateras eller läggas till i Ahuva NMS. Om filen inte anges kommer ingen enhet att läggas till eller uppdateras.',
        ],
        'options' => [
...
Kan vara en enkel mall som använder ersättningar: {{ $hostname }}, {{ $sysName }}, {{ $sysName_fallback }}, {{ $ip }}',
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'Om du inte har den gamla nyckeln måste du radera all krypterad data för att kunna fortsätta använda vissa Ahuva NMS-funktioner',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'För mer information se Ahuva NMS support (varmaenosh@gmail.com)"',
