...
return [
    'device' => [
        ...
        'create' => [
            ...
            'description' => 'Lägg till nya enheter till Ahuva NMS',
        ],
        'update' => [
        ...
        'delete' => [
            ...
            'description' => 'Ta bort enheter från Ahuva NMS',
        ],
        'debug' => [
    ...
    'api' => [
        ...
        'access' => [
            'label' => 'API-åtkomst',
            'description' => 'Få åtkomst till Ahuva NMS REST API',
        ],
    ],
    'application' => [
        'title' => 'Ansökningar',
    ...
    'poller' => [
        ...
        'delete' => [
            ...
            'description' => 'Ta bort pollers från Ahuva NMS',
        ],
    ],
    'poller-group' => [
        'title' => 'Pollergrupper',
    ...
    'settings' => [
        ...
        'view' => [
            ...
            'description' => 'Visa globala Ahuva NMS-inställningar',
        ],
        'update' => [
            'label' => 'Redigera inställningar',
            'description' => 'Ändra globala Ahuva NMS-inställningar',
        ],
    ],
    'syslog' => [
        'title' => 'Syslog',
