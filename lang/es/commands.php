...
return [
    ...
    'dev:check' => [
        'description' => 'Verificaciones de código de Ahuva NMS. Ejecutar sin opciones ejecuta todas las verificaciones',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Nombre del archivo (solo nombre base) del archivo snmprec a actualizar o agregar a Ahuva NMS. Si no se especifica el archivo, no se agregará ni actualizará ningún dispositivo.',
        ],
        'options' => [
...
Puede ser una plantilla simple usando reemplazos: {{ $hostname }}, {{ $sysName }}, {{ $sysName_fallback }}, {{ $ip }}',
    ...
    'key:rotate' => [
        ...
        'options' => [
            ...
            'forgot-key' => 'Si no tiene la clave antigua, debe eliminar todos los datos cifrados para poder continuar usando ciertas funciones de Ahuva NMS',
        ],
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Para más información vea Ahuva NMS support (varmaenosh@gmail.com)"',
