...
return [
    'title' => 'Configuración',
    'readonly' => 'Establecido en config.php, elimínelo de config.php para habilitarlo.',
    'groups' => [
        'alerting' => 'Alertas',
        'api' => 'API',
        'apps' => 'Aplicaciones',
    ...
    'sections' => [
        'alerting' => [
            'general' => [
                'name' => 'Configuración General de Alertas',
            ],
            'email' => [
                'name' => 'Opciones de Correo Electrónico',
            ],
            'rules' => [
                'name' => 'Configuración Predeterminada de Reglas de Alerta',
            ],
        ...
        'auth' => [
            'general' => [
                'name' => 'Configuración General de Autenticación',
            ],
            'ad' => [
                'name' => 'Configuración de Active Directory',
            ],
            'ldap' => [
                'name' => 'Configuración de LDAP',
            ],
            'radius' => [
                'name' => 'Configuración de Radius',
            ],
            'socialite' => [
                'name' => 'Configuración de Socialite',
            ],
            'http' => [
                'name' => 'Configuración de Autenticación HTTP',
            ],
            'sso' => [
        ...
        'authorization' => [
            'device-group' => [
                'name' => 'Configuración de Grupos de Dispositivos',
            ],
        ],
        'discovery' => [
            'general' => [
                'name' => 'Configuración General de Descubrimiento',
            ],
            'route' => [
                'name' => 'Módulo de Descubrimiento de Rutas',
            ],
            'discovery_modules' => [
                'name' => 'Módulos de Descubrimiento',
            ],
            'autodiscovery' => [
                'name' => 'Descubrimiento de Red',
            ],
            'ports' => [
                'name' => 'Módulo de Puertos',
            ],
            'storage' => [
                'name' => 'Módulo de Almacenamiento',
            ],
            'processor' => [
                'name' => 'Módulo de Procesador',
            ],
            'ipmi' => [
                'name' => 'Módulo IPMI',
            ],
            ...
            'virtualization' => [
                'name' => 'Módulo de Virtualización',
            ],
        ],
        'external' => [
            'binaries' => [
                'name' => 'Ubicaciones de Binarios',
            ],
            'location' => [
                'name' => 'Configuración de Ubicación',
            ],
            'graylog' => [
                'name' => 'Integración Graylog',
            ],
            'oxidized' => [
                'name' => 'Integración Oxidized',
            ],
            'mac_oui' => [
                'name' => 'Integración Mac OUI Lookup',
            ],
            'peeringdb' => [
                'name' => 'Integración PeeringDB',
            ],
            'nfsen' => [
                'name' => 'Integración NfSen',
            ],
            'unix-agent' => [
                'name' => 'Integración Unix-Agent',
            ],
            'smokeping' => [
                'name' => 'Integración Smokeping',
            ],
            'snmptrapd' => [
                'name' => 'Integración SNMP Traps',
            ],
            'rancid' => [
        ...
        'poller' => [
            ...
            'distributed' => [
                'name' => 'Poller Distribuido',
            ],
            'graphite' => [
                'name' => 'Almacén de Datos: Graphite',
            ],
            'influxdb' => [
                'name' => 'Almacén de Datos: InfluxDB',
            ],
            'influxdbv2' => [
                'name' => 'Almacén de Datos: InfluxDBv2',
            ],
            'kafka' => [
                'name' => 'Almacén de Datos: Kafka',
            ],
            'mtu' => [
                'name' => 'Comprobación de MTU',
            ],
            'opentsdb' => [
                'name' => 'Almacén de Datos: OpenTSDB',
            ],
            'ping' => [
                'name' => 'Ping',
            ],
            'prometheus' => [
                'name' => 'Almacén de Datos: Prometheus',
            ],
            'rrdtool' => [
                'name' => 'Almacén de Datos: RRDTool',
            ],
            'snmp' => [
                'name' => 'SNMP',
            ],
            ...
            'poller_modules' => [
                'name' => 'Módulos de Poller',
            ],
            'ports' => [
                'name' => 'Módulo de Poller de Puertos',
            ],
        ],
        'system' => [
            'billing' => [
        ...
        'webui' => [
            'availability-map' => [
                'name' => 'Configuración de Mapa de Disponibilidad',
            ],
            'custom-map' => [
                'name' => 'Configuración de Mapa Personalizado',
            ],
            'graph' => [
                'name' => 'Configuración de Gráficas',
            ],
            'dashboard' => [
                'name' => 'Configuración de Paneles',
            ],
            'port-descr' => [
                'name' => 'Análisis de Descripción de Interfaz',
            ],
            'search' => [
            ...
            'worldmap' => [
                'name' => 'Configuración de Mapa Mundial',
            ],
            'general' => [
                'name' => 'Configuración General de UI Web',
            ],
            'front-page' => [
                'name' => 'Configuración de Página Principal',
            ],
            'menu' => [
            ...
            'alert-map' => [
                'name' => 'Configuración de Mapa de Alertas',
            ],
        ],
    ],
    'settings' => [
        'active_directory' => [
            'users_purge' => [
                'description' => 'Mantener usuarios inactivos por',
                'help' => 'Los usuarios se eliminarán de Ahuva NMS después de esta cantidad de días sin iniciar sesión. 0 significa nunca y los usuarios se volverán a crear si vuelven a iniciar sesión.',
            ],
        ],
        'addhost_alwayscheckip' => [
            'description' => 'Comprobar IP duplicada al añadir dispositivos',
            'help' => 'Si un host se añade como dirección IP, se comprueba para asegurar que la IP no esté ya presente. Si la IP está presente, el host no se añade. Si el host se añade por nombre de host, esta comprobación no se realiza. Si la configuración es true, los nombres de host se resuelven y también se realiza la comprobación. Esto ayuda a evitar dispositivos duplicados accidentalmente.',
        ],
        'alert_rule' => [
            'acknowledged_alerts' => [
                'description' => 'Alertas Reconocidas',
                'help' => 'Enviar alertas cuando una alerta sea reconocida',
            ],
            'severity' => [
                'description' => 'Severidad',
                'help' => 'Severidad para una Alerta',
            ],
            ...
            'default_operation_start_in' => [
                'description' => 'Operación predeterminada: Empezar en',
                'help' => 'Retraso predeterminado antes de que se envíe una notificación de operación',
            ],
            ...
            'default_operation_notifications_suppressed' => [
                'description' => 'Operación predeterminada: Suprimir notificaciones',
                'help' => 'Suprimir notificaciones de forma predeterminada para filas de operaciones creadas',
            ],
            'invert_rule_match' => [
                'description' => 'Invertir Coincidencia de Regla',
                'help' => 'Alertar solo si la regla no coincide',
            ],
            'recovery_alerts' => [
                'description' => 'Alertas de Recuperación',
                'help' => 'Notificar si la Alerta se recupera',
            ],
            'acknowledgement_alerts' => [
                'description' => 'Alertas de Reconocimiento',
                'help' => 'Notificar si la Alerta es reconocida',
            ],
            'invert_map' => [
                'description' => 'Todos los dispositivos excepto en la lista',
                'help' => 'Alertar solo para Dispositivos que no estén listados',
            ],
        ],
        'alert' => [
            'ack_until_clear' => [
                'description' => 'Opción predeterminada de reconocer hasta que la alerta se despeje',
                'help' => 'Reconocer predeterminado hasta que se limpie la alerta',
            ],
            'admins' => [
            ...
            'disable' => [
                'description' => 'Deshabilitar alertas',
                'help' => 'Detener la generación de alertas',
            ],
            'acknowledged' => [
                'description' => 'Enviar alertas reconocidas',
                'help' => 'Notificar si la Alerta ha sido reconocida',
            ],
            'fixed-contacts' => [
                'description' => 'Deshabilitar cambios de contacto para alertas activas',
                'help' => 'Si es VERDADERO, cualquier cambio en sysContact o en los correos de los usuarios no será respetado mientras la alerta esté activa',
            ],
            'globals' => [
            ...
            'scheduled_maintenance_default_behavior' => [
                'description' => 'Comportamiento predeterminado para mantenimiento programado',
                'help' => 'Comportamiento predeterminado para mantenimiento programado',
                'options' => [
                    1 => 'Omitir alertas',
                    2 => 'Silenciar alertas',
                    3 => 'Ejecutar alertas',
            ...
            'transports' => [
                'mail' => [
                    'description' => 'Avisos por correo electrónico',
                    'help' => 'Transporte de alertas por correo',
                ],
            ],
            'tolerance_window' => [
                'description' => 'Ventana de tolerancia para cron',
        ...
        'alert_log_purge' => [
            'description' => 'Entradas de registro de alertas más antiguas que',
            'help' => 'Limpieza realizada por daily.sh',
        ],
        'discovery_on_reboot' => [
            'description' => 'Descubrimiento tras Reinicio',
            'help' => 'Realizar un Descubrimiento en un Dispositivo reiniciado',
        ],
        'allow_duplicate_sysName' => [
            'description' => 'Permitir sysName Duplicado',
            'help' => 'Por defecto, se deshabilita la adición de sysNames duplicados para evitar que un dispositivo con múltiples interfaces se añada varias veces',
        ],
        'allow_unauth_graphs' => [
            'description' => 'Permitir acceso a gráficas sin autenticar',
            'help' => 'Permite a cualquier persona acceder a las gráficas sin iniciar sesión',
        ],
        ...
        'collectd_dir' => [
            ...
            'help' => 'Directory where collectd stores its RRD files.  This is used to display data from collectd into Ahuva NMS.',
        ],
        'collectd_sock' => [
            'description' => 'Collectd Socket',
            'help' => 'Socket collectd is listening on.  This is used to display data from collectd into Ahuva NMS.',
        ],
        'core_descr' => [
        ...
        'distributed_poller' => [
            ...
            'help' => 'Enable distributed polling system wide. This is intended for load sharing, not remote polling. You must read the documentation for steps to enable: Ahuva NMS support (varmaenosh@gmail.com)',
        ],
        ...
        'mydomain' => [
            ...
            'help' => 'This domain is used for network auto-discovery and other processes. Ahuva NMS will attempt to append it to unqualified hostnames.',
        ],
        ...
        'oxidized' => [
            ...
            'ignore_os' => [
                ...
                'help' => 'Do not backup the listed OS with Oxidized.  The OS must match the Ahuva NMS OS name (these are all lowercase with no spaces).  Only allows existing OS.',
            ],
            'ignore_types' => [
        ...
        'autodiscovery' => [
            ...
            'xdp' => [
                ...
                'help' => 'Use LLDP, CDP, etc protocols to discover network topology and neighbors and add them to Ahuva NMS',
            ],
            'xdp_exclude' => [
                'sysname_regexp' => [
        ...
        'reporting' => [
            'error' => [
                ...
                'help' => 'Sends some errors to Ahuva NMS for analysis and fixing',
            ],
            'usage' => [
                'description' => 'Send Usage Reports',
                'help' => 'Reports usage and versions to Ahuva NMS. To delete anonymous stats, visit the about page. You can view stats at Ahuva NMS support (varmaenosh@gmail.com)',
            ],
            'dump_errors' => [
        ...
        'rrd_dir' => [
            ...
            'help' => 'Location of rrd files.  Default is rrd inside the Ahuva NMS directory.  Changing this setting does not move the rrd files.',
        ],
        'rrd_purge' => [
        ...
        'rrdtool_version' => [
            ...
            'help' => 'Anything over 1.5.5 supports all features Ahuva NMS uses, do not set higher than your installed version',
        ],
        'schedule_type' => [
            'alerting' => [
        ...
        'sensors' => [
            'guess_limits' => [
                ...
                'help' => 'If enabled, Ahuva NMS will try to guess the sensor limits based on the sensor type and value. This is not always accurate and may lead to incorrect limits.',
            ],
        ],
        ...
        'service_watchdog_log' => [
            ...
            'help' => 'Default is the Ahuva NMS log file. Sets the default value for all nodes.',
        ],
        'service_health_file' => [
