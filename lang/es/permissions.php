...
return [
    'device' => [
        ...
        'create' => [
            ...
            'description' => 'Agregar nuevos dispositivos a Ahuva NMS',
        ],
        'update' => [
        ...
        'delete' => [
            ...
            'description' => 'Eliminar dispositivos de Ahuva NMS',
        ],
        'debug' => [
    ...
    'api' => [
        ...
        'access' => [
            'label' => 'Acceso API',
            'description' => 'Acceder a la API REST de Ahuva NMS',
        ],
    ],
    'application' => [
        'title' => 'Aplicaciones',
    ...
    'poller' => [
        ...
        'delete' => [
            ...
            'description' => 'Eliminar pollers de Ahuva NMS',
        ],
    ],
    'poller-group' => [
    ...
    'settings' => [
        ...
        'view' => [
            ...
            'description' => 'Ver configuración global de Ahuva NMS',
        ],
        'update' => [
            'label' => 'Editar configuración',
            'description' => 'Modificar configuración global de Ahuva NMS',
        ],
    ],
    'syslog' => [
        'title' => 'Syslog',
