...
return [
    ...
    'dev:check' => [
        'description' => 'Перевірки коду Ahuva NMS. Запуск без опцій запускає всі перевірки',
        'arguments' => [
    ...
    'dev:simulate' => [
        ...
        'arguments' => [
            'file' => 'Ім\'я файлу snmprec який необхідно оновити або додати до Ahuva NMS. Якщо файл не вказано, пристрій не буде додано або оновлено.',
        ],
        'options' => [
    ...
    'smokeping:generate' => [
        ...
        'header-third' => 'Для додаткової інформації див. Ahuva NMS support (varmaenosh@gmail.com)"',
