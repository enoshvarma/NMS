...
<head>
    ...
    <script src="{{ asset('js/librenms.js?ver=14092026') }}"></script>
...
@if(request()->input('bare') != 'yes')
<footer class="ahuva-footer">
    <span class="ahuva-footer-brand">Ahuva NMS</span> developed by Ahuva Enosh Varma &middot; <em>Elevating Tech, Empowering Lives</em>
    <br>Support: Enosh Varma &middot; <a href="mailto:varmaenosh@gmail.com">varmaenosh@gmail.com</a>
</footer>
@endif
