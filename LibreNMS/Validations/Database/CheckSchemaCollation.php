    ...
    public function validate(): ValidationResult
    {
        ...
        if (empty($collation) !== true) {
            return ValidationResult::fail(
                ...
                'Convert the database and tables to utf8mb4 / utf8mb4_unicode_ci. Contact Ahuva NMS support if you need help.'
            )->setFixer(self::class);
        }
        ...
        if (empty($collation_tables) !== true) {
            return ValidationResult::fail('MySQL tables collation is wrong: ')
                ->setFix('Convert the database and tables to utf8mb4 / utf8mb4_unicode_ci. Contact Ahuva NMS support if you need help.')
                ->setFixer(self::class)
