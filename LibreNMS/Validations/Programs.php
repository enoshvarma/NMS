...
class Programs extends BaseValidation
{
    ...
    public function checkFping6(Validator $validator, $fping)
    {
        ...
        if (str_ends_with((string) $fping6, 'fping6')) {
    ...
    {
        $validator->info('fping FAILURES can be ignored if running Ahuva NMS in a jail without ::1. You may want to test it manually: fping ::1');
        $validator->fail(
